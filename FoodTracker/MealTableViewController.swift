...
class MealTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        /*
         This code creates a special type of bar button item
         that has editing behavior built into it. It
         then adds this button to the left side of the
         navigation bar in the meal list scene.
         */
    ...
    //the number of visual groupings of cells within table views
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "ShowDetail":
            ...
            // create the selected cell object
            guard let selectedMealCell = sender as? MealTableViewCell else{
                fatalError("unexpected sender: \(sender)")
            }
            
            // create the indexPath for the selected cell
